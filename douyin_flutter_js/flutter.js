...
global.FlutterHostView = FlutterHostView;
...
(function () {
  ...
  _flutter.self = {
    ...
    XMLHttpRequest: require("./flutter_bom/xml-http-request")._XMLHttpRequest,
  };
  ...
  global.XMLHttpRequest =
    require("./flutter_bom/xml-http-request")._XMLHttpRequest;
  global.crypto = _flutter.self.crypto;
  global.localStorage = _flutter.self.localStorage;
  global.Blob = _flutter.self.Blob;
  global.FileReader = _flutter.self.FileReader;
